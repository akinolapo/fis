      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed z-20 left-0 shadow-4xl right-0 top-[3.5rem] p-5 pt-0"
          >
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      className={
                        "flex items-center justify-between w-full p-5 rounded-xl bg-primary text-white text-center"
                      }
                      href={route.href}
                    >
