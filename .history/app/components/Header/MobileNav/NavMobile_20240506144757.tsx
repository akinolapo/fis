      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed z-20 bg-myDarkColor left-0 shadow-4xl right-0 top-[3.5rem] p-5 pt-0"
          >
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      className={
                        "flex items-center justify-between w-full p-5 rounded-xl bg-myLightColor text-white"
                      }
                      href={route.href}
                    >
