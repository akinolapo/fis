...
const Header = () => {
  return (
    <header className="flex justify-between items-center py-4 px-20 bg-gray-800 text-white">
      {/* Logo and Site Title */}
      ...
      {/* Join Us Button */}
      <button className="px-4 py-2 rounded-full bg-black-500 hover:bg-blue-600 text-white">
        Join Us
      </button>
    </header>
  );
