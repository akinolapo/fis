...
const Header = () => {
  return (
    <header className="flex justify-between items-center py-8 px-20 bg-gray-800 text-white">
      {/* Logo and Site Title */}
      <div className="flex items-center">
        <img src="/logo.png" alt="Logo" className="w-10 h-10 mr-2" />
        <h1 className="text-lg font-bold">Federation of Igbo Student<br></br> OAU</h1>
      </div>
