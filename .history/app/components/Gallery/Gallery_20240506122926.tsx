  ...
  return (
    <div className='py-5'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {selectedImage && (
          <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-75 flex justify-center items-center z-10" onClick={handleClose}>
            <div className="relative" onClick={(e) => e.stopPropagation()}>
            <button className="absolute top-4 right-4 bg-black bg-opacity-50 text-white text-lg p-2 rounded-full" onClick={handleClose}>
                Close (X)
              </button>
