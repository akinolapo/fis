...
const membersData = [
  ...
  { id: 4, name: 'UGWUEKE DANIEL IGWEBUIKE', position: 'FINANCIAL SECRETARY', image: '/images/member3.jpg' },
  { id: 5, name: 'OZONECHI COLLINS IKENNA', position: 'SECRETARY', image: '/images/member3.jpg' },
